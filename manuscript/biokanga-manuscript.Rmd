...
of container image identity and persistence via [content digests](https://docs.docker.com/registry/spec/api/#content-digests).
...
with the later relying on conversion of Docker container images to its ow format.
