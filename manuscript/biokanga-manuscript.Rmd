...
Meaningful benchmarking requires precise traceability of each evaluated tool
e.g. by stating the version of the tool being used.
...
we also require robust procedures for building, distributing
and using the containers.
...
for a tool, given an appropriate trigger in our workflow GitHub repository.
...
It then can be used to pull this exact version of the container image.
We use this functionality to address the BioContainer images.
For example we
The ideal
